...
export function replaceProgramIeiSection41Block(params: {
  ...
  if (!flags.hasWaterSampling) {
    ...
    // Оценка существующего экологического состояния — оставляем, но без воды
    xml = replaceParagraphTextByParaId(
      xml,
      '6F447173',
      'оценка существующего экологического состояния окружающей среды, включая оценку уровня загрязнения атмосферного воздуха, почв (грунтов) промышленными объектами, транспортными средствами, отходами производства и потребления;',
    );
  }
