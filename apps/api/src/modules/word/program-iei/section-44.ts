...
export function replaceProgramIeiSection44Block(params: { xml: string }): string {
  ...
  const section44ParaIds = [
    ...
    '40AFFE3F', // Пробоподготовка (прокаливание) — теперь «образцов ПГ и ДО»
    '534E152F', // Пробоподготовка (ПГ) — теперь «образцов ПГ и ДО»
    '6E2000B1', // Пробоподготовка (массовая доля влаги ДО) — новый абзац актуального шаблона
