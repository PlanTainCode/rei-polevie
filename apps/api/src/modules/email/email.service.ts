...
export class EmailService {
  ...
  async sendInquiryRequest(params: {
    ...
    const text = 'Добрый день!\nВо вложении письмо с запросом на получение справочной информации.\nПросим направить входящий номер письма.';

    const html = '<p>Добрый день!</p><p>Во вложении письмо с запросом на получение справочной информации.</p><p><b>Просим направить входящий номер письма.</b></p>';
