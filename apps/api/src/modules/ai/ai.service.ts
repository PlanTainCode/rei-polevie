...
- Посмотри какая роль указана: "Подрядчик" или "Исполнитель"
- contractorRole: укажи ТОЛЬКО ОДНО слово - "Подрядчик" или "Исполнитель"
  Если роль явно не указана, по умолчанию ставь "Подрядчик"
