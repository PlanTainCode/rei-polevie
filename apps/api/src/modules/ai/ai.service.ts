...
export const TEMPLATE_SERVICES = [
  ...
  },
  {
    ...
    name: 'Комплекс 1.4. (Санитарно-гигиеническое обследование почв - СанПиН)',
    fullName: 'Комплекс 1.4. (Санитарно-гигиеническое обследование почв (грунтов) в соответствии с СанПиН 2.1.3684-21, СП 502.1325800.2021)',
    unit: 'Проба',
  ...
  },
  {
    ...
    num: 7,
    category: 'Почва (стандартный перечень)',
    name: 'Комплекс 13.2. Определение острой токсичности',
    fullName: 'Комплекс 13.2. Определение острой токсичности грунтов с применением Chlorella vulgaris и Daphnia magna',
    unit: 'Проба',
  ...
  },
  {
    ...
    name: 'Комплекс 1.11. (Оценка качества почв по МГСН 1.02-02)',
    fullName: 'Комплекс 1.11. (Оценка качества почв при комплексном благоустройстве территории в соответствии с МГСН 1.02-02)',
    unit: 'Проба',
  ...
  },
  {
    ...
    name: 'Комплекс 1.23. (Исследование свойств вскрышных пород по ГОСТ)',
    fullName: 'Комплекс 1.23. (Исследование свойств вскрышных и вмещающих пород при проектировании рекультивационных работ в соответствии с ГОСТ 17.5.1.03-86)',
    unit: 'Проба',
...
- Если в тексте упоминаются тяжелые металлы, бенз(а)пирен, нефтепродукты, радионуклиды для почвы - это Комплекс 1.4 (строка 20)
- Если упоминается токсичность, биотестирование - это Комплекс 13.2 (строка 21)
- Если упоминаются агрохимические показатели, МГСН, благоустройство - это Комплекс 1.11 (строка 24)
- Если упоминается рекультивация, ГОСТ 17.5 - это Комплекс 1.23 (строка 27)
