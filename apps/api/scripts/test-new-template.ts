...
check('соц-эконом строка удалена из таблицы 4.2', !titles.some((t) => t.includes('социально-экономических условий')));
...
console.log('\n2) applyProgramIeiSection42NaturalConditionsTop10');
{
  ...
  check('соц-эконом строка таблицы удалена', !xml.includes('Характеристика социально-экономических условий'));
